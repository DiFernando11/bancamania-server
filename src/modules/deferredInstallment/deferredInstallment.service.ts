...
export class DeferredInstallmentService {
  ...
  readInstallment({
    ...
    const isInterest = deferredMonth > creditCard.monthMaxWithoutInterest
    const interestMonth = isInterest
      ? deferredMonth * creditCard.interestRate
      : 0
    ...
    return {
      adjustment,
      baseAmount,
      interestRate: isInterest ? creditCard.interestRate : 0,
      interestTotal,
      totalWithInterest,
    }
  }
